...
sudo mysql -e "CREATE TABLE dashlinx.buttons (id INT(11) AUTO_INCREMENT PRIMARY KEY, title VARCHAR(255) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT 'none', folder VARCHAR(255) DEFAULT NULL);" 2>/dev/null | sudo tee -a "$log_file" >/dev/null
